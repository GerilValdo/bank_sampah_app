...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseDepositEvent);
}
...
/// @nodoc
class $FirebaseDepositEventCopyWith<$Res>  {
$FirebaseDepositEventCopyWith(FirebaseDepositEvent _, $Res Function(FirebaseDepositEvent) __);
}


/// Adds pattern-matching-related methods to [FirebaseDepositEvent].
extension FirebaseDepositEventPatterns on FirebaseDepositEvent {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loadDeposits,TResult Function( DepositModel deposit)?  addDeposit,TResult Function( String id)?  deleteDeposit,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoadDeposits() when loadDeposits != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loadDeposits,required TResult Function( DepositModel deposit)  addDeposit,required TResult Function( String id)  deleteDeposit,}) {final _that = this;
switch (_that) {
case _LoadDeposits():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loadDeposits,TResult? Function( DepositModel deposit)?  addDeposit,TResult? Function( String id)?  deleteDeposit,}) {final _that = this;
switch (_that) {
case _LoadDeposits() when loadDeposits != null:
return loadDeposits();case _AddDeposit() when addDeposit != null:
return addDeposit(_that.deposit);case _DeleteDeposit() when deleteDeposit != null:
...
class _LoadDeposits implements FirebaseDepositEvent {
  const _LoadDeposits();
...
@override
String toString() {
  return 'FirebaseDepositEvent.loadDeposits()';
}
...
class _AddDeposit implements FirebaseDepositEvent {
  const _AddDeposit(this.deposit);
  

 final  DepositModel deposit;

/// Create a copy of FirebaseDepositEvent
...
@override
String toString() {
  return 'FirebaseDepositEvent.addDeposit(deposit: $deposit)';
}
...
/// @nodoc
abstract mixin class _$AddDepositCopyWith<$Res> implements $FirebaseDepositEventCopyWith<$Res> {
...
class _DeleteDeposit implements FirebaseDepositEvent {
...
@override
String toString() {
  return 'FirebaseDepositEvent.deleteDeposit(id: $id)';
}
...
/// @nodoc
abstract mixin class _$DeleteDepositCopyWith<$Res> implements $FirebaseDepositEventCopyWith<$Res> {
...
/// @nodoc
mixin _$FirebaseDepositState {

 List<DepositModel> get deposits; bool get isLoading; String? get errorMessage;
/// Create a copy of FirebaseDepositState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FirebaseDepositStateCopyWith<FirebaseDepositState> get copyWith => _$FirebaseDepositStateCopyWithImpl<FirebaseDepositState>(this as FirebaseDepositState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FirebaseDepositState&&const DeepCollectionEquality().equals(other.deposits, deposits)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'FirebaseDepositState(deposits: $deposits, isLoading: $isLoading, errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $FirebaseDepositStateCopyWith<$Res>  {
  factory $FirebaseDepositStateCopyWith(FirebaseDepositState value, $Res Function(FirebaseDepositState) _then) = _$FirebaseDepositStateCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$FirebaseDepositStateCopyWithImpl<$Res>
    implements $FirebaseDepositStateCopyWith<$Res> {
  _$FirebaseDepositStateCopyWithImpl(this._self, this._then);

  final FirebaseDepositState _self;
  final $Res Function(FirebaseDepositState) _then;
...
/// Adds pattern-matching-related methods to [FirebaseDepositState].
extension FirebaseDepositStatePatterns on FirebaseDepositState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _FirebaseDepositState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _FirebaseDepositState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _FirebaseDepositState value)  $default,){
final _that = this;
switch (_that) {
case _FirebaseDepositState():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _FirebaseDepositState value)?  $default,){
final _that = this;
switch (_that) {
case _FirebaseDepositState() when $default != null:
return $default(_that);case _:
...
class _FirebaseDepositState implements FirebaseDepositState {
  const _FirebaseDepositState({final  List<DepositModel> deposits = const [], this.isLoading = false, this.errorMessage}): _deposits = deposits;
...
@pragma('vm:prefer-inline')
_$FirebaseDepositStateCopyWith<_FirebaseDepositState> get copyWith => __$FirebaseDepositStateCopyWithImpl<_FirebaseDepositState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FirebaseDepositState&&const DeepCollectionEquality().equals(other._deposits, _deposits)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
/// @nodoc
abstract mixin class _$FirebaseDepositStateCopyWith<$Res> implements $FirebaseDepositStateCopyWith<$Res> {
  factory _$FirebaseDepositStateCopyWith(_FirebaseDepositState value, $Res Function(_FirebaseDepositState) _then) = __$FirebaseDepositStateCopyWithImpl;
@override @useResult
$Res call({
 List<DepositModel> deposits, bool isLoading, String? errorMessage
});
...
/// @nodoc
class __$FirebaseDepositStateCopyWithImpl<$Res>
    implements _$FirebaseDepositStateCopyWith<$Res> {
  __$FirebaseDepositStateCopyWithImpl(this._self, this._then);

  final _FirebaseDepositState _self;
  final $Res Function(_FirebaseDepositState) _then;

/// Create a copy of FirebaseDepositState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? deposits = null,Object? isLoading = null,Object? errorMessage = freezed,}) {
  return _then(_FirebaseDepositState(
