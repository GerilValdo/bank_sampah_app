...
mixin _$DepositModel {
 ...
 int? get id; int get categoryId; double get weight; int get totalPoints; String get status; String? get imageUrl; String? get notes; DateTime get createdAt; String? get nameCategory; int? get pointsPerKgCategory; String? get iconNameCategory;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,categoryId,weight,totalPoints,status,imageUrl,notes,createdAt,nameCategory,pointsPerKgCategory,iconNameCategory);

@override
String toString() {
  return 'DepositModel(id: $id, categoryId: $categoryId, weight: $weight, totalPoints: $totalPoints, status: $status, imageUrl: $imageUrl, notes: $notes, createdAt: $createdAt, nameCategory: $nameCategory, pointsPerKgCategory: $pointsPerKgCategory, iconNameCategory: $iconNameCategory)';
}
...
@useResult
$Res call({
 int? id, int categoryId, double weight, int totalPoints, String status, String? imageUrl, String? notes, DateTime createdAt, String? nameCategory, int? pointsPerKgCategory, String? iconNameCategory
});
...
as DateTime,nameCategory: freezed == nameCategory ? _self.nameCategory : nameCategory // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int categoryId,  double weight,  int totalPoints,  String status,  String? imageUrl,  String? notes,  DateTime createdAt,  String? nameCategory,  int? pointsPerKgCategory,  String? iconNameCategory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DepositModel() when $default != null:
return $default(_that.id,_that.categoryId,_that.weight,_that.totalPoints,_that.status,_that.imageUrl,_that.notes,_that.createdAt,_that.nameCategory,_that.pointsPerKgCategory,_that.iconNameCategory);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int categoryId,  double weight,  int totalPoints,  String status,  String? imageUrl,  String? notes,  DateTime createdAt,  String? nameCategory,  int? pointsPerKgCategory,  String? iconNameCategory)  $default,) {final _that = this;
switch (_that) {
case _DepositModel():
return $default(_that.id,_that.categoryId,_that.weight,_that.totalPoints,_that.status,_that.imageUrl,_that.notes,_that.createdAt,_that.nameCategory,_that.pointsPerKgCategory,_that.iconNameCategory);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int categoryId,  double weight,  int totalPoints,  String status,  String? imageUrl,  String? notes,  DateTime createdAt,  String? nameCategory,  int? pointsPerKgCategory,  String? iconNameCategory)?  $default,) {final _that = this;
switch (_that) {
case _DepositModel() when $default != null:
return $default(_that.id,_that.categoryId,_that.weight,_that.totalPoints,_that.status,_that.imageUrl,_that.notes,_that.createdAt,_that.nameCategory,_that.pointsPerKgCategory,_that.iconNameCategory);case _:
  return null;
...
class _DepositModel implements DepositModel {
   _DepositModel({this.id, required this.categoryId, required this.weight, required this.totalPoints, required this.status, this.imageUrl, this.notes, required this.createdAt, this.nameCategory, this.pointsPerKgCategory, this.iconNameCategory});
