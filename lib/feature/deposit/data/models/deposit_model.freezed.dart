...
@override
String toString() {
  return 'DepositModel(id: $id, categoryId: $categoryId, weight: $weight, totalPoints: $totalPoints, status: $status, imageUrl: $imageUrl, notes: $notes, createdAt: $createdAt)';
}
...
class _DepositModel implements DepositModel {
   _DepositModel({required this.id, required this.categoryId, required this.weight, required this.totalPoints, required this.status, this.imageUrl, this.notes, required this.createdAt});
