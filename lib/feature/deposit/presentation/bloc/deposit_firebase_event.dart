...
abstract class DepositFirebaseEvent with _$DepositFirebaseEvent {
  const factory DepositFirebaseEvent.loadDeposits(String userId) =
      _LoadDeposits;

  const factory DepositFirebaseEvent.addDeposit({
    required DepositFirebaseModel deposit,
    File? imageFile,
  }) = _AddDeposit;

  const factory DepositFirebaseEvent.updateDeposit(
